...
\date{Package version \texttt{\Sexpr{sversion}}\\ Last edited November 2013}
\maketitle
...
can be computed by \texttt{bestdoubledive}.
...
Pedro Antonio Neves and Peter Buzzacott. 
This package also incorporates results of joint research with Andrew Bassom.
