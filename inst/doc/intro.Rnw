...
\date{Package version \texttt{\Sexpr{sversion}}\\ Last edited August 2011}
\maketitle
...
\verb!<Adrian.Baddeley@csiro.au>!
with generous contributions and feedback from Vittorio Broglio
and Pedro Antonio Neves. This package incorporates results of joint research
with Andrew Bassom.
